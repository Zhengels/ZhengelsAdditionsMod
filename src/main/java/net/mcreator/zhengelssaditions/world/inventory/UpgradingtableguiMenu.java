...
public class UpgradingtableguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public UpgradingtableguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ZhengelssAditionsModMenus.UPGRADINGTABLEGUI.get(), id);
