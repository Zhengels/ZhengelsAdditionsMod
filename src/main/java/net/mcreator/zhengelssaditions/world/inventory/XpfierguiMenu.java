...
public class XpfierguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public XpfierguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ZhengelssAditionsModMenus.XPFIERGUI.get(), id);
