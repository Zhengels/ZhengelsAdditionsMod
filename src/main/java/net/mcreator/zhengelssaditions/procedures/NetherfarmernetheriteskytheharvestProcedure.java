...
public class NetherfarmernetheriteskytheharvestProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		double w = 0;
		w = 0;
		if ((world.getBlockState(BlockPos.containing(x - 2, y, z + 1))).getBlock() == Blocks.NETHER_WART) {
			{
			...
			if ((entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == Items.NETHER_WART && (entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getCount() >= 21) {
				world.setBlock(BlockPos.containing(x - 2, y, z + 1), Blocks.NETHER_WART.defaultBlockState(), 3);
				w = w + 1;
			}
		}
		if ((world.getBlockState(BlockPos.containing(x - 2, y, z - 1))).getBlock() == Blocks.NETHER_WART) {
		...
		if ((world.getBlockState(BlockPos.containing(x + 1, y, z - 2))).getBlock() == Blocks.NETHER_WART) {
			{
			...
			if ((entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == Items.NETHER_WART && (entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getCount() >= 21) {
				world.setBlock(BlockPos.containing(x + 1, y, z - 2), Blocks.NETHER_WART.defaultBlockState(), 3);
				w = w + 1;
			}
		}
		if ((world.getBlockState(BlockPos.containing(x - 1, y, z - 2))).getBlock() == Blocks.NETHER_WART) {
