...
public class CopperexposehoeProcedure {
	public static void execute(Entity entity, ItemStack itemstack) {
		...
		if (entity.isInWaterRainOrBubble()) {
			if (Math.random() < 0.0005) {
				tool = new ItemStack(ZhengelssAditionsModItems.EXPOSEDCOPPERHOE.get()).copy();
				tool.setDamageValue(itemstack.getDamageValue());
				if (entity instanceof Player _player) {
					ItemStack _stktoremove = new ItemStack(ZhengelssAditionsModItems.COPPERHOE.get());
