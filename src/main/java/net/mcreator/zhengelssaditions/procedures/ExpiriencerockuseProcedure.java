...
public class ExpiriencerockuseProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, ItemStack itemstack) {
		if (world instanceof ServerLevel _level)
			_level.sendParticles(ParticleTypes.TOTEM_OF_UNDYING, x, (y + 1), z, 20, 0, 0, 0, 0.3);
		if (world instanceof ServerLevel _level)
			_level.sendParticles(ParticleTypes.TOTEM_OF_UNDYING, x, (y + 1), z, 10, 0, 0, 0, 0.5);
		if (world instanceof ServerLevel _level)
