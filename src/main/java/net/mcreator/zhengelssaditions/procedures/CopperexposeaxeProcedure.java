...
public class CopperexposeaxeProcedure {
	public static void execute(Entity entity, ItemStack itemstack) {
		...
		if (entity.isInWaterRainOrBubble()) {
			if (Math.random() < 0.0005) {
				tool = new ItemStack(ZhengelssAditionsModItems.EXPOSEDCOPPERAXE.get()).copy();
				tool.setDamageValue(itemstack.getDamageValue());
				if (entity instanceof Player _player) {
					ItemStack _stktoremove = new ItemStack(ZhengelssAditionsModItems.COPPERAXE.get());
