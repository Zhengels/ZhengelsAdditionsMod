...
public class NetheriteskytheharvestProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if ((world.getBlockState(BlockPos.containing(x, y, z))).is(BlockTags.create(new ResourceLocation("minecraft:crops")))) {
			a = 0;
			if ((world.getBlockState(BlockPos.containing(x - 2, y, z + 1))).is(BlockTags.create(new ResourceLocation("minecraft:crops")))) {
				{
				...
				world.setBlock(BlockPos.containing(x - 2, y, z + 1),
			...
			if ((world.getBlockState(BlockPos.containing(x + 1, y, z - 2))).is(BlockTags.create(new ResourceLocation("minecraft:crops")))) {
				{
					BlockPos _pos = BlockPos.containing(x + 1, y, z - 2);
					Block.dropResources(world.getBlockState(_pos), world, BlockPos.containing(entity.getX(), entity.getY() + 1, entity.getZ()), null);
					world.destroyBlock(_pos, false);
				}
				world.setBlock(BlockPos.containing(x + 1, y, z - 2),
						((entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() instanceof BlockItem _bi ? _bi.getBlock().defaultBlockState() : Blocks.AIR.defaultBlockState()), 3);
				if (EnchantmentHelper.getItemEnchantmentLevel(ZhengelssAditionsModEnchantments.AUTOFILL.get(), itemstack) != 0) {
					if (entity instanceof Player _player) {
						ItemStack _stktoremove = (entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY);
			...
			if ((world.getBlockState(BlockPos.containing(x, y, z + 2))).is(BlockTags.create(new ResourceLocation("minecraft:crops")))) {
				{
					BlockPos _pos = BlockPos.containing(x, y, z + 2);
					Block.dropResources(world.getBlockState(_pos), world, BlockPos.containing(entity.getX(), entity.getY() + 1, entity.getZ()), null);
					world.destroyBlock(_pos, false);
				}
				world.setBlock(BlockPos.containing(x, y, z + 2),
						((entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() instanceof BlockItem _bi ? _bi.getBlock().defaultBlockState() : Blocks.AIR.defaultBlockState()), 3);
				if (EnchantmentHelper.getItemEnchantmentLevel(ZhengelssAditionsModEnchantments.AUTOFILL.get(), itemstack) != 0) {
					if (entity instanceof Player _player) {
						ItemStack _stktoremove = (entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY);
			...
			if ((world.getBlockState(BlockPos.containing(x + 2, y, z))).is(BlockTags.create(new ResourceLocation("minecraft:crops")))) {
				{
					BlockPos _pos = BlockPos.containing(x + 2, y, z);
					Block.dropResources(world.getBlockState(_pos), world, BlockPos.containing(entity.getX(), entity.getY() + 1, entity.getZ()), null);
					world.destroyBlock(_pos, false);
				}
				world.setBlock(BlockPos.containing(x + 2, y, z),
						((entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() instanceof BlockItem _bi ? _bi.getBlock().defaultBlockState() : Blocks.AIR.defaultBlockState()), 3);
				if (EnchantmentHelper.getItemEnchantmentLevel(ZhengelssAditionsModEnchantments.AUTOFILL.get(), itemstack) != 0) {
					if (entity instanceof Player _player) {
						ItemStack _stktoremove = (entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY);
			...
			NetherfarmernetheriteskytheharvestProcedure.execute(world, x, y, z, entity);
		}
	}
}
