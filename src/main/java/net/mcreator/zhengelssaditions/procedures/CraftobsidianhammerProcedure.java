...
public class CraftobsidianhammerProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((world.getBlockState(BlockPos.containing(x, y, z))).is(BlockTags.create(new ResourceLocation("zhengelss_aditions:wet")))) {
			if (entity instanceof Player _player) {
				ItemStack _stktoremove = new ItemStack(ZhengelssAditionsModItems.LAVAHAMMER.get());
				_player.getInventory().clearOrCountMatchingItems(p -> _stktoremove.getItem() == p.getItem(), 1, _player.inventoryMenu.getCraftSlots());
			}
			if (entity instanceof Player _player) {
				ItemStack _stktoremove = new ItemStack(ZhengelssAditionsModItems.OBSIDIANHAMMER.get());
				_player.getInventory().clearOrCountMatchingItems(p -> _stktoremove.getItem() == p.getItem(), 1, _player.inventoryMenu.getCraftSlots());
			}
			...
			if (entity instanceof Player _player) {
				ItemStack _setstack = new ItemStack(ZhengelssAditionsModItems.OBSIDIANHAMMER.get()).copy();
