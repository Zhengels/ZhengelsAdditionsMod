...
public class ObsidiantotemworkProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == ZhengelssAditionsModItems.OBSIDIANTOTEM.get()) {
			if (entity.isOnFire()) {
				if (world.isClientSide())
					Minecraft.getInstance().gameRenderer.displayItemActivation(new ItemStack(ZhengelssAditionsModItems.OBSIDIANTOTEM.get()));
		...
		} else if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == ZhengelssAditionsModItems.OBSIDIANTOTEM.get()) {
			if (entity.isOnFire()) {
				if (world.isClientSide())
					Minecraft.getInstance().gameRenderer.displayItemActivation(new ItemStack(ZhengelssAditionsModItems.OBSIDIANTOTEM.get()));
				if (world instanceof Level _level) {
