...
import net.mcreator.zhengelssaditions.procedures.CopperweatherknucklesProcedure;

public class ExposedcopperknucklesItem extends SwordItem {
	public ExposedcopperknucklesItem() {
		super(new Tier() {
			public int getUses() {
				return 201;
			}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		CopperweatherknucklesProcedure.execute(entity, itemstack);
	}
}
