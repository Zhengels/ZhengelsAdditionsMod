...
import net.mcreator.zhengelssaditions.procedures.CopperweatherskytheProcedure;

public class ExposedcopperskytheItem extends SwordItem {
	public ExposedcopperskytheItem() {
		super(new Tier() {
			public int getUses() {
				return 201;
			}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		CopperweatherskytheProcedure.execute(entity, itemstack);
	}
}
