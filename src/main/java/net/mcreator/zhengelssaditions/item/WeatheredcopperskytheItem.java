...
import net.mcreator.zhengelssaditions.procedures.CopperoxidizeskytheProcedure;

public class WeatheredcopperskytheItem extends SwordItem {
	public WeatheredcopperskytheItem() {
		super(new Tier() {
			public int getUses() {
				return 201;
			}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		CopperoxidizeskytheProcedure.execute(entity, itemstack);
	}
}
