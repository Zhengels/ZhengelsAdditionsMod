...
import net.mcreator.zhengelssaditions.procedures.CopperexposeknucklesProcedure;

public class CopperknucklesItem extends SwordItem {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		CopperexposeknucklesProcedure.execute(entity, itemstack);
	}
}
