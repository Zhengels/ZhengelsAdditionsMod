...
import net.mcreator.zhengelssaditions.procedures.KnucklestickProcedure;
...
public class WaxedweatheredcopperknucklesItem extends SwordItem {
	public WaxedweatheredcopperknucklesItem() {
		super(new Tier() {
			public int getUses() {
				return 201;
			}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		KnucklestickProcedure.execute(itemstack);
	}
}
